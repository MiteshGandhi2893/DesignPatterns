...
public class Driver {
    ...
    public static void main(String[] args)
    {
       ...
       // result.setFilename("/Users/miteshgandhi/NetBeansProjects/wordTree/src/wordTree/driver/Output.txt");
       // result.setFilename(output);
        ...
        try {
            //BufferedReader reader=new BufferedReader(new FileReader("/Users/miteshgandhi/NetBeansProjects/wordTree/src/wordTree/driver/input.txt"));
