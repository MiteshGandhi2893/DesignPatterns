    ...
    AirportSecuritySystem airpotSystem;
        ...
        String moderateOperation="2 3 5 8 9";
        String highOperation="2 4 6 8 10";
      

        public HighRisk(AirportSecuritySystem newAirportSystem ) {
            airpotSystem=newAirportSystem;
             MyLogger.writeMessage("Inside the High Risk class",MyLogger.DebugLevel.CONSTRUCTOR);

        }

        
         /**
         * This function calculates rge 
         */
